...
func main() {
	...
	defer cancel()
	client, err := mongo.Connect(ctx, options.Client().ApplyURI(os.Getenv("mongodb+srv://Gopikanth123:Gopikanth@cluster0.1awun.mongodb.net/myFirstDatabase?retryWrites=true&w=majority")))
	defer func() {
